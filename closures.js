...
var potentialSecondLevelFriends = secondLevelFriends.filter(function (val) {
    return isNotAFriend(val);
});
var allPotentialFriends = allUsers.filter(function (val1) {
    return isNotAFriend(val1);
});
